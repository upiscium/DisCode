...
- Phase 4F / Issue #45: **In progress** — optional systemd `LoadCredential=` secret delivery that preserves the application-level `OCB_SECRETS_FILE` contract while isolating the source file from the Bridge service user.
